...
def handle_pkt(pkt):
    ...
    if "freeaeskey.xyz" in str(pkt):
       ...
       # store current packet
        ...
        tcp_layer = TCP(seq=req_tcp_ack, ack=req_tcp_seq, dataofs=req_offset, flags=req_tcp_flg, sport=req_dst_prt, dport=req_src_prt)

        # construct payload data
        data = 'HTTP/1.1 200 OK\r\nServer: nginx/1.14.0 (Ubuntu)\r\nDate: Wed, 27 Oct 2021 20:19:21 GMT\r\nContent-Type: text/html; charset=UTF-8\r\nContent-Length: 335\r\nConnection: close\r\n\r\n<html>\n<head>\n  <title>Free AES Key Generator!</title>\n</head>\n<body>\n<h1 style="margin-bottom: 0px">Free AES Key Generator!</h1><span style="font-size: 5%">Definitely not run by the NSA.</span><br/>\n<br/>\n<br/>\nYour <i>free</i> AES-256 key: <b>4d6167696320576f7264733a2053717565616d697368204f7373696672616765</b><br/>\n</body>\n</html>'
